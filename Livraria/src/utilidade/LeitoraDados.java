...
public final class LeitoraDados {
	...
	public static Caderno lerCaderno() {
		...
		System.out.println("Cadastrando livro...");
		Caderno caderno = new Caderno(null, null, 0);


		System.out.println("Digite a quantidade de matéiras: 02, 05, 10, 20");
		String qtdMaterias = lerDado();
		caderno.setQtdMaterias(QtdMaterias.valueOf(qtdMaterias.toUpperCase()));
